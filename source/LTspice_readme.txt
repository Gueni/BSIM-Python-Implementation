###############################################################################
#    Simulation model of INFINEON BTS7040-1EPZ for LTspice                    #
###############################################################################

-------------------------------------------------------------------------------
1. Revision history
-------------------------------------------------------------------------------
Package version    | Date of release  | Description of changes  
-------------------------------------------------------------------------------
v04_03             | 2023-09-08       | Thermal updates
-------------------------------------------------------------------------------
...
The delivery package contains the following: 
    /Documentation/
       Introduction_to_Simulation_Model   :details on model features and limitations
       GettingStarted      	          :details on how to simulate the model
       Disclaimer
    /Model/
       *.asc                     : LTspice project file
       *.asy                     : LTspice symbol
